...
public class Worm_State_Flank : Worm_State
{
    ...
    public override void OnEnter()
    {
        ...
        Vector3 randomDir = new Vector3(Random.Range(-1, 2), 0, Random.Range(-1, 2));
        Vector3 dir = Player_Movement.position - _worm.transform.position;
        Vector3 dirToFlank = dir.normalized + randomDir.normalized;


       
        int layer = IA_Manager.instance.wall_Mask.LayerBitmapToInt();
        ...
        _worm.AI_move.OnDestinationReach += OnExit;
    }
